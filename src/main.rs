...
use esp_hal::{spi::master::Spi, time::RateExtU32 as _};
...
async fn main(_spawner: Spawner) {
    ...
    // let pins = watchy::Pins::new(peripherals);

    // let mut i2c = watchy::init_i2c(peripherals.I2C0, pins.i2c);
    ...
    // let mut vibration_motor = watchy::VibrationMotor::new(pins.vibration_motor);

    let spi = Spi::new(
        peripherals.SPI3,
        esp_hal::spi::master::Config::default().with_frequency(20_u32.MHz()),
    )
    .unwrap()
